...
const { parseCsvLine, REQUIRED_COLUMNS } = require(path.join(projectRoot, "research/lib/entity-master.js"));
const { getRegistrableDomain, safeHostname } = require(path.join(projectRoot, "packages/geo-core/evidence/brand-match.js"));

const inputDir = path.join(projectRoot, "research/inputs/xinyi-restaurants-2026");
const outDir = path.join(projectRoot, "research/inputs");
