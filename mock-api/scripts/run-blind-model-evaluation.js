...
const { loadEnvFiles, requireEnv } = require("../lib/env");
const { extractMetadata, stripHtml } = require("../lib/html-v2");
const { buildGeoQueryPlanPrompt } = require("../lib/query-planner");
...
const outputDir = path.resolve(args["output-dir"] || path.join("research-output", `blind-model-evaluation-${stamp()}`));
