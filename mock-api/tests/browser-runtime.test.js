...
const { configureBrowserRuntime, hermeticBrowserPath } = require("../lib/browser-runtime");
const installScript = fs.readFileSync(path.resolve(__dirname, "../scripts/install-browser-runtime.js"), "utf8");
