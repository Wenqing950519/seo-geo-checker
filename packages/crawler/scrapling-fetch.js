...
const { configureBrowserRuntime, hermeticBrowserPath } = require("./browser-runtime.js");

const PROJECT_ROOT = path.resolve(__dirname, "../..");
const SCRIPT_PATH = path.join(PROJECT_ROOT, "packages/crawler/scripts/scrapling-fetch.py");
