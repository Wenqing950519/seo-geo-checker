...
export function renderHeader() {
  ...
  // Unauthenticated: brand only. The sign-in action lives on the gate card,
  // which also explains what signing in gives you; a second identical button
  // up here added a place to click but no information.
  if (!isAuthed) {
    return `
    ...
    <header class="dashboard-topbar">
      ...
      <div class="topbar-controls">
        ...
        <div class="meta-status-text">
          ...
          <span>下次追蹤：<strong>${nextRunTime ? formatCountdownDays(nextRunTime) : '尚未排定'}</strong></span>
        </div>
