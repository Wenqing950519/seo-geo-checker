...
const { extractMetadata, looksClientRendered } = require("../../packages/crawler/html-v2.js");
const { parseRobotsTxt, evaluateRobotsAccess } = require("../../packages/crawler/technical-signals.js");
const { collectScoringSignals, computeScoreV2, WEIGHTS } = require("../../packages/geo-core/scoring/scoring-v2.js");
