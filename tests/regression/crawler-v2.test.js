...
const { assessCrawlQuality, chooseBetterResult, shouldRenderWithBrowser } = require("../../packages/geo-core/site-analyzer/crawl-quality.js");
const { extractInternalLinks } = require("../../packages/crawler/html-v2.js");
const { looksLikeBotChallenge, waitForBotChallengeToClear } = require("../../packages/crawler/browser-fetch-v2.js");
const { buildGoogleTranslateUrl, fetchHomepageWithGoogleTranslate } = require("../../packages/crawler/google-translate-fetch.js");
const { chooseRepresentativeUrls } = require("../../packages/crawler/technical-signals.js");
const { collectScoringSignals } = require("../../packages/geo-core/scoring/scoring-v2.js");
