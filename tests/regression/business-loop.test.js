...
const { createAuditCache } = require("../../services/api/storage/audit-cache.js");
const { createFunnelRecorder } = require("../../apps/web/analytics/funnel-events.js");
const { assertSafePublicUrl, isPrivateIp } = require("../../packages/crawler/url-safety.js");
const { createAnalytics } = require("../../apps/web/public/analytics.js");
...
async function main() {
  ...
  const serverSource = fs.readFileSync(path.resolve(__dirname, "../../services/api/server.js"), "utf8");
